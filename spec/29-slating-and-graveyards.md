...
- **Superseded by §11's 2026-09-25 amendment: a forgiven id never comes back.** The text below describes
  the earlier design. `health().forgiven` still counts forgiven ids. Its `present` now counts only bytes a
