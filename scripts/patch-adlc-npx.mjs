...
// `npx` resolves fine in any shell. Net effect: `adlc review` has never worked on Windows.
//
...
// word-split, and any `&`, `|`, `^` or backtick is executed. `adlc review` forwards diff paths and
// free-text prompts, so that is live input. A review pointed at the wrong target is precisely the
