...
import { artifactPage, MAX_CONNECTOR_NAME, type ArtifactCoordinates } from "./artifact-page.js";
...
export function packArtifactImpl(
  ...
  return { page: artifactPage({ coordinates, binding, capability }), capability, manifest };
}
