// The FLOOR a renderer stands on, and the read GESTURE that reaches it — proven on the host that
// exists today, which is the only place it can be proven at all.
//
